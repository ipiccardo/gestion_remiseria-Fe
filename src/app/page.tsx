    ...
    <div className="font-sans">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center bg-black bg-opacity-50 text-white p-8 z-40 top-0 left-0 right-0 bottom-0">
        ...
        <Link href="/dashboard/drivers"
          className="bg-blue-700 text-white py-3 pt-1 px-6 rounded-lg hover:bg-blue-800 transition duration-300 w-48 flex justify-center mt-3.5 text-5xl items-center">Enter
        </Link>
      </div>
    </div>
  );

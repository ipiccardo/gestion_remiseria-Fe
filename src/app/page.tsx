...
export default function Home() {
  return (
    <div className="font-sans">
      ...
      <div className="bg-[url('/images/portada.jpg')] max-h-screen absolute top-0 left-0 right-0 bottom-0 bg-no-repeat bg-cover">
      </div>

      <div className="absolute inset-0 flex flex-col justify-center max-h-screen items-center bg-black bg-opacity-50 text-white p-8 z-40">
